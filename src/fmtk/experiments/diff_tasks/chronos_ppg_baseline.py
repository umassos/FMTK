...
from papagei.linearprobing.feature_extraction_chronos import get_embeddings_chronos
...
#     outputs, _ = pipeline.embed(signal)
...
extract_features_and_save(model=pipeline,
                         ppg_dir=ppg_dir,
                         batch_size=batch_size,
                         device=device,
                         output_idx=0,
...
results_chronos_s_diasbp = regression(save_dir=save_dir,
...
results_chronos_s_hr = regression(save_dir=save_dir,
                                    model_name='chronos-t5-tiny',
                                    content="patient",
                                    df_train=df_train,
                                    df_val=df_val,
...
results_chronos_s_sysbp = regression(save_dir=save_dir,
                                    model_name='chronos-t5-tiny',
                                    content="patient",
                                    df_train=df_train,
                                    df_val=df_val,
...
print(f"chronos-S Diastolic BP MAE: {results_chronos_s_diasbp['mae']}")
print(f"chronos-S Systolic BP MAE: {results_chronos_s_sysbp['mae']}")
print(f"chronos-S HR MAE: {results_chronos_s_hr['mae']}")
