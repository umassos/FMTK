...
from papagei.linearprobing.feature_extraction_moment import get_embeddings
...
results_moment_s_diasbp = regression(save_dir=save_dir,
...
results_moment_s_hr = regression(save_dir=save_dir,
                                    model_name='MOMENT-1-large',
                                    content="patient",
                                    df_train=df_train,
                                    df_val=df_val,
...
results_moment_s_sysbp = regression(save_dir=save_dir,
                                    model_name='MOMENT-1-large',
                                    content="patient",
                                    df_train=df_train,
                                    df_val=df_val,
...
print(f"moment-S Diastolic BP MAE: {results_moment_s_diasbp['mae']}")
print(f"moment-S Systolic BP MAE: {results_moment_s_sysbp['mae']}")
print(f"moment-S HR MAE: {results_moment_s_hr['mae']}")
