...
class VQADataset(TimeSeriesDataset):
    def __init__(self, dataset_cfg, task_cfg, split):
        ...
        self.image_dir = os.path.join(self.dataset_cfg['dataset_path'], "val2014")
        self.json_path = os.path.join(self.dataset_cfg['dataset_path'], "val.json")
        self._read_data()

        # ✅ Add preprocessing transforms (resize + tensor)
