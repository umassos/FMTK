...
class LlamaModel(BaseModel):
    def __init__(self, device, model_name='llama-3.1-8b', model_config=None):
        super().__init__()
        self.device = device
        ...
        model_id = LLAMA_MODELS.get(model_name, model_name)
        print(f"[LLaMA] Loading {model_id} on device {device}")
