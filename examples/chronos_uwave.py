...
def train_model(
    ...
    linear_decoder = P.add_decoder(
        LinearDecoder(device,cfg={'input_dim':2304,'output_dim':8}),
        load=True,
    )
    end_time = timeit.default_timer()
    ...
    P.train_eval(
        ...
        path="gestureclass_chronosbase_linear",
        test_loader=dataloader_test,
        metric_fn=get_accuracy,
        mlflow_cfg={
            "experiment_name": "gestureclass_chronosbase_linear",
            "run_name": "gestureclass_chronosbase_linear",
            "extra_params": {
                "model_id": model_id,
                "model_cfg": model_cfg,
