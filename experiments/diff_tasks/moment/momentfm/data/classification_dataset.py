...
class ClassificationDataset:
    def __init__(self, data_split="train"):
        ...
        self.seq_len = 512
        self.train_file_path_and_name = "/work/pi_shenoy_umass_edu/hshastri/foundation-model-zoo/dataset/ECG5000/ECG5000_TRAIN.ts"
        self.test_file_path_and_name = "/work/pi_shenoy_umass_edu/hshastri/foundation-model-zoo/dataset/ECG5000/ECG5000_TEST.ts"
